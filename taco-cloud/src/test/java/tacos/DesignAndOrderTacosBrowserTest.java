...
public class DesignAndOrderTacosBrowserTest {
    ...
    private void assertDesignPageElements() {
        ...
        List<WebElement> ingredientGroups = (List<WebElement>) browser.findElement(By.cssSelector("ingredient-group"));
    ...
    private List<String> getValidationErrorTexts() {
        List<WebElement> validationErrorElements = (List<WebElement>) browser.findElement(By.cssSelector("validationError"));
